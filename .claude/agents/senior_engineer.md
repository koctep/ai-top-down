...
1. **Architecture (STEP 2):**
   ...
   - Output a summary of the architecture created. The orchestrator will pass it to the **Team Lead** for review.
...
2. **Code Review (During STEP 3):**
   ...
   - Once you approve the iteration, output your approval. The orchestrator will hand back to the
     **Junior Software Engineer** to continue development.
...
3. **Observability (STEP 5):**
   ...
   - Output a summary of observability changes. The orchestrator will pass it to the **Team Lead** for final reviews.
